...
const form = useForm({
    ...
    payment_deadline: props.invoice.payment_deadline.slice(0, 10),
    products: [],
    total: props.invoice.total,
    total_no_vat: props.invoice.total_no_vat,
...
const handleSubmit = () => {
    ...
    form.post(route('invoices.form.post', {id: props.invoice.id}), {
        onSuccess: () => {
            router.visit(route('invoices.index'));
        },
        onError: (errors) => {
        ...
        <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-6">
            ...
            <form @submit.prevent="handleSubmit">
                    ...
                    <CardContent>
                        <div class="space-y-2">
                                ...
                                <ClientSearch
                                    ...
                                    :default-value="form.client_name"
                                />
                        </div>
                ...
                <div class="mt-6 flex justify-end">
                    <Button type="submit" class="w-full md:w-auto">Edit Invoice</Button>
                </div>
            </form>
        </div>

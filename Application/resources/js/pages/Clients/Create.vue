        ...
        <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-6">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold tracking-tight">Add New Client</h1>
                        <p class="text-muted-foreground">Fill in the client information below</p>
                    </div>
                </div>
            </div>
                ...
                <Card>
                    ...
                    <CardContent class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Client Type -->
                            <FormField :error="form.errors.clientType">
                                <Label for="clientType">Tip client *</Label>
                                <Select v-model="form.clientType" required>
                                    <SelectTrigger :class="{ 'border-red-500': form.errors.clientType }">
